          ...
          <div className="h-full">
            {!file ? (
              ...
              <div className="relative h-64 bg-slate-900 rounded-lg flex flex-col items-center justify-center border border-slate-700 p-4">
                <button
                  onClick={clearFile}
                  className="absolute top-2 right-2 p-1.5 bg-slate-800 hover:bg-red-500/20 hover:text-red-400 rounded-full text-slate-400 transition-colors"
                >
                  <X className="w-5 h-5" />
                </button>
                ...
                {file.previewUrl ? (
                  <img src={file.previewUrl} alt="Preview" className="h-40 object-contain rounded mb-4" />
                   ...
                   <div className="mb-4">
                     <FileType className="w-20 h-20 text-blue-400" />
                   </div>
                )}
